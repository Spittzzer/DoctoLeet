    ...
    <div align="center" style="padding:70px">
        ...
        <table>
            ...
            <tr style="background-color:grey">
                <th style="padding:10px;font-size:20px;color:white">Doctor_Name</th>
            ...
            <tr style="background-color:grey">
                ...
                <td style="padding:10px;font-size:20px;color:white"><a class="btn btn-danger"
